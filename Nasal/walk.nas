...
var toggle_upperdoor = func {
  door4 = aircraft.door.new ("/controls/doors/door4",3);
  if(getprop("/controls/doors/door4/position-norm") > 0 and getprop("/controls/doors/door5/position-norm") == 0) {
      door4.close();
  } else {
...
### Zone corners, right, heigth, left z
    zoneData = [
               ...
               ["fwd Bridge",-2.5,2.5,13.1,11.4,0,-1,-1],
               ["Bridge doors",-2.5,2.5,15.1,11.4,0,-1,-1],       
               ["rear Bridge",-2.5,2.5,15.7,11.4,0,-1,-1],
               ["rear Bridge door",-1.5,-1.0,20.3,11.4,0,-1,-1],
               ["Rear Bridge deck",-5.0,5.0,20.5,11.4,0,-1,-1],
               ["Rear Bridge deck2",-4.0,4-0,25.9,11.4,0,-1,-1],
               ["End",0,0,30.8,0,0,-1,-1],
